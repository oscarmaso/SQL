...
CREATE TABLE OFERTAS (
	...
	CONSTRAINT PK_Ofertas PRIMARY KEY (Nombre_TARIFAS,Marca_MOVIL_CONTRATO,Modelo_MOVIL_CONTRATO)
);
...
CREATE TABLE CONTRATOS (
	...
	FOREIGN KEY (DNI_Cliente) REFERENCES CLIENTES(DNI),
	FOREIGN KEY (Nombre_Tienda) REFERENCES TIENDAS(Nombre),
	FOREIGN KEY (Nombre_OPERADORAS_TARIFAS_OFERTAS,		Nombre_TARIFAS_OFERTAS,	Marca_MOVILES_OFERTAS,	Modelo_MOVILES_OFERTAS)
		REFERENCES OFERTAS(Nombre_OPERADORAS_TARIFAS,	Nombre_TARIFAS,		Marca_MOVIL_CONTRATO,	Modelo_MOVIL_CONTRATO)
);
